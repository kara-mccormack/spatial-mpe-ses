...
working.dir = "/Users/karamccormack/Box/SES-environment/Spatial LCM Paper/v2/spatial-mpe-ses/output/scratch/Simulation1/"
...
logPost = list()
for(i in 1:length(nClusInit)){
  logPost[[i]] <- read.table(file.path(working.dir, paste0("init", nClusInit[i], "_logPost.txt")))[,1]
}
